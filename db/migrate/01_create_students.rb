...
# a new file called 02_add_bio_to_students.rb that will modify the students
# table to include a TEXT column for the bio.

# You could also create a migration 02_student_attributes.rb that adds the rest
